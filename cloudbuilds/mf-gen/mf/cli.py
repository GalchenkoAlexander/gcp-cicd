...
def main():
    ...
    parser.add_argument("--built_at", help="Current build datetime with timezone", required=True)
    ...
    build_info = BuildInfo(git_branch=args.git_brunch, git_sha=args.git_sha, date=args.built_at)
